                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brandname" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                </div>
                                <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" name="notes" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                </div> -->
                                <!-- <div class="form-group">
                                    <label for="exampleInputEmail1">Items in stock</label>
                                    <input type="text" name="stock" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                </div> -->
                                <!-- <div class="form-group">
                                    <label for="exampleInputPassword1">Items in ordered</label>
                                    <input type="text" name="ordered" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                </div> -->
                                <!-- <div class="form-group">
                                ...
                                <button type="submit" name="save" value="savedata" class="btn btn-info">Submit</button>
                            </form>
                            </div>
